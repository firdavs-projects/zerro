          ...
          <>
            ...
            <Box mt={1}>
              <Typography variant="body1">
                ...
                <br />
                Не помогло? Тогда в{' '}
                <A href="https://zenmoney.ru/a/#accounts">
                  веб-версии Дзен-мани
                </A>{' '}
                обновите начальный остаток у счетов из списка ниже. Поменяйте
                его, сохраните, и верните обратно.
                <br />
                Опять не помогло? Тогда смело пишите мне в телеграме (
                <A href="https://t.me/ardov">@ardov</A>
                ), помогу разобраться с проблемой.
              </Typography>
